...
setup:
    ...
    MOVLW 0b10000111 ; | /RBPU | ((OPTION_REG) and 07Fh), 6 | ((OPTION_REG) and 07Fh), 5 | ((OPTION_REG) and 07Fh), 4 | ((OPTION_REG) and 07Fh), 3 | ((OPTION_REG) and 07Fh), 2 | ((OPTION_REG) and 07Fh), 1 | ((OPTION_REG) and 07Fh), 0 |
    MOVWF OPTION_REG

    ; interruptions configuration
    BANKSEL INTCON ; enable global interruptions and enagle ((INTCON) and 07Fh), 5
